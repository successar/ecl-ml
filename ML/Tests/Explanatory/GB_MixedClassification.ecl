...
f_types := ML.DecisionTree.Utils.GetFieldTypes(indep, DATASET([], FieldType), is_cont_default:=FALSE);
...
grad_tree_model := Tree(indep, dep, f_types, iterations:=5, doNormalize:=TRUE);
